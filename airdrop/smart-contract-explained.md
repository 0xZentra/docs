...
* **Fixed airdrop allocation**: 0.5% of total supply for direct airdrop; depletion ends the program, with timing recorded via on-chain events. Official-bridge inflows also consume this 0.5% pool but do not grant options.
